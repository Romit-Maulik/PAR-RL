...
```
where `head_redis_address` was obtained after the head node process was started. If this is successfully executed - you may now use Ray for several distributed tasks. 
