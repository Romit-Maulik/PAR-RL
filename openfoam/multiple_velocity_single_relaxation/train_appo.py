...
#    config["model"]["use_lstm"] = True
    ...
    env_params = {}
    env_params['write_frequency'] = 1000 # update frequency for relaxation factors
...
#    trainer = a2c.A2CTrainer(config=config, env="myenv")
    ...
    file_results = 'Training_iterations.txt'
...
#        for i in range(ncount):
        i = 0
        while result['training_iteration'] <= 5:
            ...
            if result['timesteps_total'] % 200000 == 0:
