...
#        )
        ...
        a1_low = env_config['a1_low']
        a1_high = env_config['a1_high']

        # Lower bound for relaxation factors
        turb_model_low = np.array([a1_low])        
        
        # Upper bound for relaxation factors
        turb_model_high  = np.array([a1_high])
...
#        )
    ...
    def step(self, action):
        ...
        turb_model["RAS"]["kOmegaSSTCoeffs"]["a1"] = self.a1[0]
...
#        logger_m.info(f'{self.worker_index}')
        ...
        row = np.array([self.worker_index,self.vx,self.a1[0],itercount,
...
if __name__ == '__main__':
    ...
    env_config['a1_low'] = 0.2
    env_config['a1_high'] = 2.0
