...
#                        logger_g.info(f'{self.vx[0]} velocity solution converged with {itercount} iterations')
                    else:
                        reward = 0
...
#                )
        ...
        row = np.array([self.worker_index,self.vx,relax_u,relax_p,itercount,U2,res_ux,res_uy,res_p,res_k,res_eps,reward])
