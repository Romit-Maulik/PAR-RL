...
#    config["lr"] = 2.5e-4
#    config["horizon"] = 4000
    config["sgd_minibatch_size"] = 64  # Total SGD batch size across all devices for SGD. This defines the minibatch size of each SGD epoch
...
#    trainer.restore('./PPO_myenv_2020-07-02_22-21-04h3jttxrm/checkpoint_35/checkpoint-35')
...
#        for i in range(ncount):
        i = 0
        while result['episodes_total'] <= 800:
